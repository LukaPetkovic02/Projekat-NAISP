...
//OVDE JE SKIP LISTA ALI SE MOZE OBRISATI JER SAM ISKOPIRAO U FAJL SKIP LISTA
...
func (s *SkipList) Put(podatak Importi.Podatak) []Importi.Podatak { //na kraju preimenuj u put
