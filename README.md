...
- [done ] Make helper functions for k and m of bloom
- [done ] Make function that returns bytes of populated bloomFilter
- [done ] Make function that deserializes bloomFilter
- [done ] Make function that checks if element is in bloomFilter
